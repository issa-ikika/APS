...
public class MysticalCardGame {
    ...
    public static void startDuel(SLL<Card> firstSorcererCards, SLL<Card> secondSorcererCards) {
        SLLNode<Card> cardFirst = firstSorcererCards.getFirst();
        SLLNode<Card> cardSecond = secondSorcererCards.getFirst();
        SLLNode<Card> bestCard = null;
        int p = 4;
        int prod = cardFirst.element.getHealth() * cardFirst.element.getMagicPower();

        while(cardFirst != null) {
            int pr = cardFirst.element.getHealth() * cardFirst.element.getMagicPower();
            ...
            cardFirst = cardFirst.succ;
        }

        cardSecond = secondSorcererCards.getFirst();
        SLLNode<Card> bestCard2 = null;

        while(cardSecond != null){
            if(p == 0){
                bestCard2 = cardSecond;
            }
            p--;
            cardSecond = cardSecond.succ;
        }

        secondSorcererCards.insertBefore(bestCard.element, bestCard2);
